...
Page({
    ...
    onShow: function () {
        ...
        requestUtil.get(_DuoguanData.duoguan_host_api_url + '/index.php?s=/addon/DuoguanDish/ApiFapiao/getFapiaoList.html', rq_data, (info) => {
    ...
    fapiao_formSubmit:function(e){
        ...
        requestUtil.get(_DuoguanData.duoguan_host_api_url + '/index.php?s=/addon/DuoguanDish/ApiFapiao/addFapiao.html', q_data, (info) => {
    ...
    fapiao_edit_bind:function(e){
        ...
        requestUtil.get(_DuoguanData.duoguan_host_api_url + '/index.php?s=/addon/DuoguanDish/ApiFapiao/getFapiaoInfo.html', { fapiao_id: fapiao_id}, (info) => {
    ...
    delete_fapiao_bind:function(){
        ...
        requestUtil.get(_DuoguanData.duoguan_host_api_url + '/index.php?s=/addon/DuoguanDish/ApiFapiao/deleteFapiao.html', { fapiao_id: fapiao_id }, (info) => {
            that.setData({ this_show_type: 0, this_edit_type: 'add', this_fapiao_leixing: 1, this_fapiao_info: null });
            that.onShow();
        }, this, {});
    },
