...
Page({
    data: {
        ...
        heixiao: {
            menus: [
                { name: "hexiao", text: "cancel after verification", link: "pages/user/exam/index", icon: "icon-duoguan-hexiao", },
            ],
            type: 'line'
        },
        open_card_info: {
    ...
    onPullDownRefresh: function () {
        ...
        requestUtil.get(API_MENU_URL, { ver_id: VERSION }, (data, res) => {
            data.push({
                menus: [
                  { name: "settings", text: "set", link: "pages/user/setting/index", icon: "icon-xitongshezhi", },
                ],
                type: 'line'
            });
    ...
    onNavigateTap: function (e) {
        ...
        if ("wechat_address" == name) {
            ...
            wx.showToast({ title: 'Loading...', icon: 'loading', duration: 10 });
            wx.clearStorageSync();
            wx.showToast({ title: 'Complete', icon: 'success', duration: 1500 });
    ...
    onGetPhoneNumber: function (e) {
        ...
        const handler = (code) => {
            ...
            requestUtil.post(url, {
            ...
            }, this, { isShowLoading: true, loadingText: 'Acquisition', completeAfter: function(res) {
                // 兼容处理 此次为兼容支付宝小程序
                ...
                open_card_info['isDisabled'] = false;
    ...
    onGetVerifyCodeTap: function (e) {
        ...
        requestUtil.post(url, { phone: this.data.open_card_info.phone }, (info) => {
          wx.showToast({ title: 'Verification code sent successfully, please check!', });
    ...
    onOpenTap: function () {
        ...
        requestUtil.post(url, {
          ...
          wx.showToast({ title: 'Open successfully!' });
            const card_info = this.data.card_info;
            card_info.show = false;
            card_info.status = 1;
            this.setData({ card_info: card_info });
