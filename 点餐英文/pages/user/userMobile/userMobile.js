...
Page({
    ...
    data: {
        ...
        reload_verify_time: 'Get the verifying code',
    },
    ...
    init: function (options) {
        ...
        dg.setNavigationBarTitle({
          title: action == 'bind' ? 'Associated cell phone number' : 'To update'
        });
        this.setData({
            action: action
        });
        ...
        dg.authLogin({
            success: function(res) {
                ...
                request.post(requestUrl, requestData, function(info){
                    ...
                    isShowLoading: true, loadingText: 'Acquisition', completeAfter: function(res){
    ...
    getVerifyCode: function (e) {
        ...
        request.post(requestUrl, requestData, function(res){
          dg.showToast({ title: 'Please remember to check！', });
