...
module.exports = {
  ...
  required: function (value, title = null) {
     ...
     */
    if ( title == null || title == '' ) {
      title = 'The input item cannot be empty!'
    }
    if (value == null || value == "" ) {
      return this.showToastError(title)
    }
    if ( value.replace(/(^\s*)|(\s*$)/g, "") == "" ) {
      return this.showToastError('The input item cannot be a space!')
    }
  ...
  isMobile: function(mobile, title = null) {
     ...
     */
    if ( mobile.length == 0 ) {
      return this.showToastError('Please enter your cell phone number')
    }
    if (mobile.length != 11) {
      return this.showToastError('Please check the length of your cell phone number')
    }
    let reg = /^(((13[0-9]{1})|(15[0-9]{1})|(18[0-9]{1})|(17[0-9]{1}))+\d{8})$/;
    if (!reg.test(mobile)) {
      return this.showToastError('The phone number is wrong, please recheck it!')
    }
  ...
  isIdCard: function (idcard) {
    ...
    if (!isValid) {
      return this.showToastError('Please fill in the correct ID number')
    }
