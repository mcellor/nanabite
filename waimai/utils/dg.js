...
export default class core {
	 ...
	 * @type {Function}
	 */
    static reLaunch = core.os.isWechat() ? wx.reLaunch : my.reLaunch;

	/**
	 * 跳转到同主体小程序（打开同一公众号下关联的另一个小程序）
	 * @param {Object} options （支付宝不支持 envVersion 参数）
	 * @type {Function}
	 */
    static navigateToMiniProgram = core.os.isWechat() ? wx.navigateToMiniProgram : my.navigateToMiniProgram;
	 ...
	 * @type {Function}
	 */
    static navigateBackMiniProgram = core.os.isWechat() ? wx.navigateBackMiniProgram : my.navigateBackMiniProgram;
	 ...
	 * @type {Function}
	 */
	static getSetting = core.os.isWechat() ? wx.getSetting : function(){
	 ...
	 * @type {Function}
	 */
	static setSetting = core.os.isWechat() ? wx.setSetting : function () {
	 ...
	 * @type {Function}
	 */
    static startPullDownRefresh = core.os.isWechat() ? wx.startPullDownRefresh : my.startPullDownRefresh || function () {
        console.warn("支付宝暂不支持开始下拉刷新~");
    };
