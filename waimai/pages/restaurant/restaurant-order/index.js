...
Page({
            ...
            requestUtil.get(_DuoguanData.duoguan_host_api_url + '/index.php?s=/addon/DuoguanDish/Api/getCartList.html', rq_data, (info) => {
                ...
                if (that.data.this_order_id > 0){
                    requestUtil.get(_DuoguanData.duoguan_host_api_url + '/index.php/addon/DuoguanDish/ApiNewOrder/orderInfo.html', { oid: that.data.this_order_id }, (info) => {
                        that.setData({ this_table_id: info.order_table_id_zhen});
                        that.getTableInfo();
                    }, that, {});
                }else{
                    that.getTableInfo();
    ...
    order_formSubmit: function (e) {
        ...
        requestUtil.get(_DuoguanData.duoguan_host_api_url + '/index.php/addon/DuoguanDish/ApiNewOrder/postOrder.html', { oinfo: order_info }, (info) => {
