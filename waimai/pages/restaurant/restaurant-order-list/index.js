...
Page({
    ...
    delete_user_order: function (e) {
        ...
        wx.showModal({
            ...
            success: function (res) {
                if (res.confirm == true) {
                    requestUtil.get(_DuoguanData.duoguan_host_api_url + '/index.php/addon/DuoguanDish/ApiNewOrder/deleteUserOrder.html', { oid: oid }, (info) => {
                        that.onShow();
                    }, that, {});
                }
            }
    ...
    onShow: function () {
        ...
        requestUtil.get(_DuoguanData.duoguan_host_api_url + '/index.php?s=/addon/DuoguanDish/ApiNewOrder/getUserOrderList.html', requestData, (info) => {
