...
Page({
    ...
    onShow: function () {
        var that = this;
        that.setData({ this_is_recharge:false, this_rc_ohers_active: false, this_rc_jiner: 0, this_input_jiner: 0 });
        requestUtil.get(_DuoguanData.duoguan_host_api_url + '/index.php?s=/addon/DuoguanDish/Api/getDishOneInfo.html', { dish_id: that.data.this_dish_id }, (info) => {
            ...
            WxParse.wxParse('g_description', 'html', info.card_info, that, 5);
    ...
    user_recharge_view_bind:function(){
        ...
        requestUtil.get(_DuoguanData.duoguan_host_api_url + '/index.php/addon/DuoguanDish/ApiCard/getRechargeConfig.html', requestData, (info) => {
            console.log(info)
    ...
    go_recharge_bind:function(){
        ...
        requestUtil.get(_DuoguanData.duoguan_host_api_url + '/index.php/addon/DuoguanMemberCard/Api/cardRecharge.html', requestData, (info) => {
            wx.requestPayment({
        ...
        }, that, { isShowLoading: true, completeAfter:function(){
